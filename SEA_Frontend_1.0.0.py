...
ventana_base.iconbitmap('.\\Grafico\\loto.ico')
...
imagen_nuevo = PhotoImage('Nuevo', file='.\\Grafico\\nuevo.png')
...
imagen_abrir = PhotoImage('Abrir', file='.\\Grafico\\abrir.png')
...
menu_de_dialogo.add_separator()
imagen_guardar = PhotoImage('Guardar', file='.\\Grafico\\guardar.png')
...
menu_de_dialogo.add_separator()
imagen_salir = PhotoImage('Salir', file='.\\Grafico\\salir.png')
...
imagen_acerca = PhotoImage('Acerca', file='.\\Grafico\\acerca.png')
...
imagen_dialogar = PhotoImage('dialogar',
                             file='.\\Grafico\\dialogar.png')
imagen_configurar = PhotoImage('configurar',
                               file='.\\Grafico\\configurar.png')
